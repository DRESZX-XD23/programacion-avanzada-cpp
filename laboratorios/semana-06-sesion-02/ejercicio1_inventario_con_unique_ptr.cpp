...
std::unique_ptr<int[]> stock(new int[cantidadProductos]);
...
// notas clase
//puntero debil: parra ver si una cosa este viva o no
// unique pointer solo uno
// puntero a una pantalla de inicio que todos vean para eso: shared pointer