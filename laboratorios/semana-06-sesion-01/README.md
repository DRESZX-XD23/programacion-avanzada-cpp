...
dice que eso es temporal, osea que convierte al objeto en una rvalue
...
porque consmumiria demasiada memoria y seria mas lento
...
copia la direccion, no el arreglo
...
hay un bug con el delete ya que, Al final de main se destruyen registro2 y luego registro1.
...
osea la 2 seria  roba el puntero, dejaralturas en nullptr y poner en capacidad 0
...
**Respuesta 2:** si dejo `otro.alturas` en `nullptr` después de robarlo, ¿por qué eso hace que el destructor de `otro` sea seguro cuando se ejecute más tarde?
 ...
 ya no crea el bug de dos deletes ya que deja el puntero nulo
**La formulación completa, tal como la resuelvo yo:**
