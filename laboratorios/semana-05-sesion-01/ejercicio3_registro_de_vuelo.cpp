...
//"Registro de vuelo creado para <capacidad> lecturas"
 }

 void guardarAltura(int indice, double valor){alturas[indice] = valor;}
 double getAltura(int indice){return alturas[indice];}

~RegistroDeVuelo(){delete[] alturas; std::cout<<"memoria liberada"<<std::endl;}
